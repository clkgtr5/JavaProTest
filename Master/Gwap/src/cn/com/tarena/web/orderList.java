...
import cn.com.tarena.service.orderListServer;
...
public class orderList extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			orderListServer orderliste = new OrderlistServiceImpl();
	...
	private void toStudentList(HttpServletResponse resp, List orderList)
		...
		for(Iterator<Orders> it = orderList.iterator();it.hasNext();){
			...
			n++;
		out.println("			<tr>");
		out.println("				<td class=tablebody2 valign=middle align=center>"+n+"</td>");
		out.println("				<td class=tablebody1 valign=middle>&nbsp;&nbsp;<a href=\"orderDetail?id="+order.getOrderid()+"\">"+order.getOrderid()+"</a></td>");
